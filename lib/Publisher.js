				...
				if( fs.existsSync( newFile ) ){
					...
					if( !component.adequate || component.adequate() ){
						...
						if( self.globalConfig.entities.configurator )
							self.ignite( self.globalConfig.entities.configurator + '.' + (self.options.configFn || 'getConfigFor'), self.globalConfig.entities.appName, component.name, function(err, config){
