...
var gutil = global.gutil = require("gulp-util"),
	webpack = global.webpack = require("webpack"),
...
[
	...
	viewTasks.push( tasks.views ); styleTasks.push( tasks.styles ); jsTasks.push( tasks.js );
